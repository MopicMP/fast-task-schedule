...
> Fast schedule python functions (cron-like)

[![PyPI version](https://badge.fury.io/py/fast-task-schedule.svg)](https://pypi.org/project/fast-task-schedule/)
...
```bash
pip install fast-task-schedule
```

## Quick Start

```python
from fast_task_schedule import schedule
...
from fast_task_schedule import batch
